...
(function($){
	...
	$(document).ready(function(){
		...
		$(document).delegate('.anularPedido', 'click', function(event) {
			...
			if( confirm('Confirme anular Pedido') ){
		...
		/* -------------------------------------- */
		$('.anularPE').click(function(event) {
			/* Act on the event */
			var _idPE = $(this).attr('href');
			alertify.confirm('Confirme anular Parte Entrada',function(e){
				if(e){
					$.post( _servicio , { f:'delPE', idpe : _idPE } , function(data, textStatus, xhr) {
