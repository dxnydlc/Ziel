                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="text-primary" >Reporte de ventas</h4>
                        </div>
                        <!-- /panel-heading -->
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr id="Fila_<?php echo $rs->id; ?>" class="<?php echo $cla; ?>" >
                                                                ...
                                                                <td>
                                                                    <a href="<?php echo $link.$rs->id; ?>" target="_blank" ><strong><?php echo $rs->var_Nombre; ?></strong></a>
                                                                </td>
...
<?php include_once('popup1.php'); ?>
    ...
    <script src="../dist/js/rep_ventas_todos.js<?php echo $rand; ?>"></script>
