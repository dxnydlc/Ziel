...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Mantenimiento de Clases de Productos</h1>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table class=" table table-hover " id="tblClases" >
                                <thead>
                                    <tr>
...
<?php include_once('popup1.php'); ?>
    ...
    <script src="../dist/js/mant_clases.js<?php echo $rand; ?>"></script>
