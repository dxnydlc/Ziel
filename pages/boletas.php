...
$data_ventas = $OBJ->get_listado_ventas('');
...
@media only screen and (max-width: 760px),(min-device-width: 768px) and (max-device-width: 1024px)  {    
    ...
    Label the data
    */
    td:nth-of-type(1):before { content: "Correlativo:"; }
    td:nth-of-type(2):before { content: "Cliente:"; }
    td:nth-of-type(3):before { content: "Pedido:"; }
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" >Boletas de venta</h1>
                </div>
            </div>
            <!-- /.row -->
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <ul class="list-inline" >
                        <li>
                            <a href="nueva-boleta.php" class="btn btn-primary btn-outline" ><i class="fa fa-plus"></i> Nueva Boleta</a>
                        </li>
                    </ul>
                </div>
                <!-- col-lg-6 -->
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr class="<?php echo $cla; ?>" >
                                                <td><?php echo $rs->int_Correlativo; ?></td>
                                                <td>
                                                    <a href="nueva-boleta.php?id=<?php echo $rs->id; ?>" ><strong><?php echo $rs->var_Nombre; ?></strong></a>
                                                </td>
                                                ...
                                                <td>
                                                    <ul class="list-inline" >
                                                        <li>
                                                            <a class="anularBoleta pull-left btn btn-primary btn-outline" href="<?php echo $rs->id; ?>" alt="" data-toggle="tooltip" data-placement="top" title="Anular Boleta" ><i class="fa fa-times"></i> </a>
                                                        </li>
                                                    </ul>
                                                </td>
                                            </tr>
...
<?php include_once('popup1.php'); ?>
    ...
    <script src="../dist/js/boletas.js<?php echo $rand; ?>"></script>
