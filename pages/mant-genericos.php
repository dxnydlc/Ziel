...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Mantenimiento de Productos Genericos</h1>
                    <p>Sirve para clasificar un producto dentro de un conjunto de productos.</p>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table class=" table table-hover " id="tblGenerico" >
                                <thead>
                                    <tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Agregar una nueva clase</h4>
      </div>

    <form name="frmData" id="frmData" method="post" autocomplete="off" >
        <input type="hidden" name="idGenerico" id="idGenerico" value="" />
        <input type="hidden" name="f" id="f" value="" />
      <div class="modal-body">
          <div class="form-group">
            <label for="txtNombre" >Nombre de Clase</label>
...
<?php include_once('popup1.php'); ?>
    ...
    <script src="../dist/js/mant_generico.js<?php echo $rand; ?>"></script>
